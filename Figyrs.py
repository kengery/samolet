import pygame
#Рисует квадрат
def kvadrat(display,color,x,y,l):
    pygame.draw.line(display, color, (x, y), (x + l, y))
    pygame.draw.line(display, color, (x + l, y), (x + l, y + l))
    pygame.draw.line(display, color, (x + l, y + l), (x, y + l))
    pygame.draw.line(display, color, (x, y + l), (x, y))
